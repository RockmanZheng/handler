...
class DatabaseHandler(Handler):
    ...
    def read_csv(self,
                 ...
                 table: str):
        """
        Read csv file in path into table on database, replacing the existing table
        """
        if self.port is not None:
...
class AwsS3Handler(object):
    ...
    def upload_part(self,
                    ...
                    pbar: tqdm):
        """
        Wrapper for S3 upload_part
        """
        response = self.client.upload_part(Body=chunk,
                                            Bucket=self.bucket,
                                            Key=key,
                                            PartNumber=num,
                                            UploadId=upload_id)
    ...
    def upload_file(self,
                   ...
                   upload_freq: int = 10):
        """
        Upload file efficiently using concurrency and AWS S3 multipart upload API
        """
